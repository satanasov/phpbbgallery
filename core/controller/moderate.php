	...
	*/
	public function image($image_id)
	{
		...
		$this->template->assign_vars(array(
			...
			'UC_IMAGE'			=> $this->image->generate_link('medium', $this->config['phpbb_gallery_link_thumbnail'], $image_data['image_id'], $this->image->parse_image_name($image_data['image_name']), $image_data['image_album_id']),
