...
$lang = array_merge($lang, array(
	...
	'DISP_TOTAL_IMAGES'				=> 'Покажи "Общо изобраения" на index.' . $phpEx,
	...
	'SHORTED_IMAGENAMES_EXP'		=> 'Ако името на изображението е твърде дълно и не включва спейсове, изгледът може да бъде унищожен (-1 за изключване).<br><code>В момента тази функция се изпълнява от CSS и е оставена тук само и единствено за удобстовто на администратора. </code>',
