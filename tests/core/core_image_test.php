...
class core_image_test extends core_base
{
	 ...
	 */
	public function test_generate_link_to_image_page()
	{
		$content = 'image_name';
		$mode = 'image_page';
		$image_id = 1;
		...
		$this->assertStringContainsString('image_id=1', $result);
		$this->assertStringContainsString('album_id=1', $result);
		$this->assertStringContainsString('title="test_image"', $result);
	}

	public function test_generate_link_to_image()
	{
		$content = 'image_name';
		$mode = 'image';
		$image_id = 1;
	...
	public function test_generate_link_to_next_image()
	{
		$content = 'image_name';
		$mode = 'next';
		$image_id = 1;
	...
	public function test_generate_link_to_thumbnail()
	{
		$content = 'thumbnail';
		$mode = 'image_page';
		$image_id = 1;
