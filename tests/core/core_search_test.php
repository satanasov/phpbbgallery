		...
		$this->template->expects($this->exactly(2))
			...
			->withConsecutive(
				array('imageblock', array(
					'BLOCK_NAME' => 'recent',
					'U_BLOCK' => 'phpbbgallery_search_egosearch'
				)),
	...
	public function test_rrc_gindex_display_random($state, $expect)
	{
		...
		$this->template->expects($this->exactly(2))
			...
			->withConsecutive(
				array('imageblock', array(
					'BLOCK_NAME' => 'random',
					'U_BLOCK' => 'phpbbgallery_search_random'
				)),
				array('imageblock.image', $expect)
			);
	...
	*/
	public function link_image_name_data()
	{
		return array(
			'image_page' => array(
				'image_page', // Input
				'phpbbgallery_image', // expected
			),
			'image' => array(
				'image', // Input
				'phpbbgallery_image_file_source', // expected
			),
			'other' => array(
				'none',
				false
		...
		$this->template->expects($this->exactly(6))
			...
			->withConsecutive(
				array('commentrow', array(
					'COMMENT_ID' => 6,
					'U_DELETE'	=> 'phpbbgallery_comment_delete',
					'U_EDIT' => 'phpbbgallery_comment_edit',
					'U_QUOTE'	=> 'phpbbgallery_comment_add',
					'U_COMMENT'	=> 'phpbbgallery_image#comment_6',
					'POST_AUTHOR_FULL'	=> 2,
					'TIME'	=> null,
					'TEXT'	=> 'This is test comment 6!!!!!',
					'UC_IMAGE_NAME'	=> '<a href="phpbbgallery_image">TestImage6</a>',
					'UC_THUMBNAIL'	=> null,
					'IMAGE_AUTHOR'	=> 52,
					'IMAGE_TIME'	=> null,
				)),
				array('commentrow', array(
					...
					'U_EDIT' => 'phpbbgallery_comment_edit',
					'U_QUOTE'	=> 'phpbbgallery_comment_add',
					'U_COMMENT'	=> 'phpbbgallery_image#comment_5',
					'POST_AUTHOR_FULL'	=> 2,
					'TIME'	=> null,
					'TEXT'	=> 'This is test comment 5!!!!!',
					'UC_IMAGE_NAME'	=> '<a href="phpbbgallery_image">TestImage5</a>',
					'UC_THUMBNAIL'	=> null,
					'IMAGE_AUTHOR'	=> 53,
					'IMAGE_TIME'	=> null,
				)),
				array('commentrow', array(
					...
					'U_EDIT' => 'phpbbgallery_comment_edit',
					'U_QUOTE'	=> 'phpbbgallery_comment_add',
					'U_COMMENT'	=> 'phpbbgallery_image#comment_4',
					'POST_AUTHOR_FULL'	=> 2,
					'TIME'	=> null,
					'TEXT'	=> 'This is test comment 4!!!!!',
					'UC_IMAGE_NAME'	=> '<a href="phpbbgallery_image">TestImage4</a>',
					'UC_THUMBNAIL'	=> null,
					'IMAGE_AUTHOR'	=> 2,
					'IMAGE_TIME'	=> null,
				)),
				array('commentrow', array(
					...
					'U_EDIT' => 'phpbbgallery_comment_edit',
					'U_QUOTE'	=> 'phpbbgallery_comment_add',
					'U_COMMENT'	=> 'phpbbgallery_image#comment_3',
					'POST_AUTHOR_FULL'	=> 52,
					'TIME'	=> null,
					'TEXT'	=> 'This is test comment 3!!!!!',
					'UC_IMAGE_NAME'	=> '<a href="phpbbgallery_image">TestImage3</a>',
					'UC_THUMBNAIL'	=> null,
					'IMAGE_AUTHOR'	=> 52,
					'IMAGE_TIME'	=> null,
				)),
				array('commentrow', array(
					...
					'U_EDIT' => 'phpbbgallery_comment_edit',
					'U_QUOTE'	=> 'phpbbgallery_comment_add',
					'U_COMMENT'	=> 'phpbbgallery_image#comment_2',
					'POST_AUTHOR_FULL'	=> 52,
					'TIME'	=> null,
					'TEXT'	=> 'This is test comment 2!!!!!',
					'UC_IMAGE_NAME'	=> '<a href="phpbbgallery_image">TestImage2</a>',
					'UC_THUMBNAIL'	=> null,
					'IMAGE_AUTHOR'	=> 2,
					'IMAGE_TIME'	=> null,
				)),
				array('commentrow', array(
					...
					'U_EDIT' => 'phpbbgallery_comment_edit',
					'U_QUOTE'	=> 'phpbbgallery_comment_add',
					'U_COMMENT'	=> 'phpbbgallery_image#comment_1',
					'POST_AUTHOR_FULL'	=> 52,
					'TIME'	=> null,
					'TEXT'	=> 'This is test comment 1!!!!!',
					'UC_IMAGE_NAME'	=> '<a href="phpbbgallery_image">TestImage1</a>',
					'UC_THUMBNAIL'	=> null,
					'IMAGE_AUTHOR'	=> 2,
					'IMAGE_TIME'	=> null,
				))
