		...
		$this->template->expects($this->exactly(6))
			...
			->withConsecutive(
				array('commentrow', array(
					...
					'UC_THUMBNAIL'	=> '<a href="phpbbgallery_core_image" title="TestImage6" style="display: inline;"><img src="http://gallery/image/6/mini" alt="TestImage6" title="TestImage6" style="max-width: 100%; max-height: 100%"/></a>',
					'IMAGE_AUTHOR'	=> 52,
					'IMAGE_TIME'	=> null,
				)),
				array('commentrow', array(
					...
					'UC_THUMBNAIL'	=> '<a href="phpbbgallery_core_image" title="TestImage5" style="display: inline;"><img src="http://gallery/image/5/mini" alt="TestImage5" title="TestImage5" style="max-width: 100%; max-height: 100%"/></a>',
					'IMAGE_AUTHOR'	=> 53,
					'IMAGE_TIME'	=> null,
				)),
				array('commentrow', array(
					...
					'UC_THUMBNAIL'	=> '<a href="phpbbgallery_core_image" title="TestImage4" style="display: inline;"><img src="http://gallery/image/4/mini" alt="TestImage4" title="TestImage4" style="max-width: 100%; max-height: 100%"/></a>',
					'IMAGE_AUTHOR'	=> 2,
					'IMAGE_TIME'	=> null,
				)),
				array('commentrow', array(
					...
					'UC_THUMBNAIL'	=> '<a href="phpbbgallery_core_image" title="TestImage3" style="display: inline;"><img src="http://gallery/image/3/mini" alt="TestImage3" title="TestImage3" style="max-width: 100%; max-height: 100%"/></a>',
					'IMAGE_AUTHOR'	=> 52,
					'IMAGE_TIME'	=> null,
				)),
				array('commentrow', array(
					...
					'UC_THUMBNAIL'	=> '<a href="phpbbgallery_core_image" title="TestImage2" style="display: inline;"><img src="http://gallery/image/2/mini" alt="TestImage2" title="TestImage2" style="max-width: 100%; max-height: 100%"/></a>',
					'IMAGE_AUTHOR'	=> 2,
					'IMAGE_TIME'	=> null,
				)),
				array('commentrow', array(
					...
					'UC_THUMBNAIL'	=> '<a href="phpbbgallery_core_image" title="TestImage1" style="display: inline;"><img src="http://gallery/image/1/mini" alt="TestImage1" title="TestImage1" style="max-width: 100%; max-height: 100%"/></a>',
					'IMAGE_AUTHOR'	=> 2,
					'IMAGE_TIME'	=> null,
				))
			);
